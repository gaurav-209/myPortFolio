          ...
          <div className="section-2">
            <div className="story-container">
              <div className="story-left">
                ...
                <p>My technical journey began with mastering <strong>JavaScript, HTML5, CSS3</strong>, and <strong>Python</strong>. I soon discovered the power of <strong>React.js</strong>, which revolutionized my approach to front-end development. One of my proudest achievements is <a href="https://ayirakids.com/" target="_blank"><strong>AyiraKids.com</strong></a>, an online store I co-developed, focusing on creating a <strong>responsive, user-centric, and visually captivating interface</strong>. This project cemented my love for coding and collaboration.</p>
                <p>During my internship as a <strong>Web Developer</strong>, I advanced my expertise by creating a fully responsive <strong>single-page application</strong> for a dental care website using React.js. This project showcased my proficiency in <strong>React Router</strong> for seamless navigation and my ability to design <strong>modular, reusable components</strong> that optimize performance and scalability.</p>
